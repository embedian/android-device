...
currently suported platforms: smarc-8mm, smarc-8mq, smarc-8mp

eg: ./uuu_imx_android_flash.sh -f imx8mm -a -e -D ~/smarc_8mp/ -t emmc -u trusty -d hdmi
...
options:
  ...
  -u uboot_feature  flash uboot or spl&bootloader image with "uboot_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx8mp       │  dual trusty-dual smarc-uuu trusty-secure-unlock-dual
			   ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
imx8mp_uboot_feature=(dual trusty-dual smarc-uuu trusty-secure-unlock-dual)
