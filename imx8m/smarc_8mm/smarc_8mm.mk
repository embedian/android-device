...
# Overrides
PRODUCT_NAME := smarc_8mm
PRODUCT_DEVICE := smarc_8mm
PRODUCT_MODEL := SMARC_8MM
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/init.imx8mm.lpddr4.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nxp.additional.rc \
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/init.imx8mm.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nxp.imx8mm.rc \
