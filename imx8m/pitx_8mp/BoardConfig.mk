...
CMASIZE=1184M
# NXP default config
BOARD_KERNEL_CMDLINE := init=/init console=ttymxc3 firmware_class.path=/vendor/firmware loop.max_part=7 bootconfig
...
# display config
BOARD_BOOTCONFIG += androidboot.lcd_density=240 androidboot.displaymode=1080p60
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
    ...
    imx8mp:imx8mp-pitx.dtb \
    imx8mp-lvds:imx8mp-pitx-lvds.dtb \
    imx8mp-rs485:imx8mp-pitx-rs485.dtb \
    imx8mp-lvds-rs485:imx8mp-pitx-lvds-rs485.dtb
endif
