...
currently suported platforms: smarc-8mm, smarc-8mq, pitx-8mp, smarc-8mp

eg: ./uuu_imx_android_flash.sh -f imx8mm -a -e -D ~/pitx_8mp/ -t emmc -u trusty -d hdmi
...
options:
  ...
  -u uboot_feature  flash uboot or spl&bootloader image with "uboot_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx8mm       │  4g 4g-dual 4g-trusty-dual 4g-smarc-uuu                     │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx8mn       │  dual trusty-dual evk-uuu trusty-secure-unlock-dual ddr4-evk-uuu ddr4                                │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx8mq       │  dual trusty-dual smarc-uuu trusty-secure-unlock-dual                                                │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx8mp       │  dual trusty-dual pitx-uuu trusty-secure-unlock-dual
			   ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
imx8mm_uboot_feature=(4g 4g-dual 4g-trusty-dual 4g-smarc-uuu)
imx8mn_uboot_feature=(dual trusty-dual evk-uuu trusty-secure-unlock-dual ddr4-evk-uuu ddr4)
imx8mq_uboot_feature=(dual trusty-dual smarc-uuu trusty-secure-unlock-dual)
imx8mp_uboot_feature=(dual trusty-dual pitx-uuu trusty-secure-unlock-dual)
...
imx8mq_dtb_feature=(hdmi dcss-lvds dp lcdif-lvds dual-display)
imx8mp_dtb_feature=(lvds rs485 lvds-rs485)
