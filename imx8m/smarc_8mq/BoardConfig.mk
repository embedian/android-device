...
BOARD_PREBUILT_DTBOIMAGE := $(OUT_DIR)/target/product/$(PRODUCT_DEVICE)/dtbo-imx8mq-hdmi.img
...
# NXP default config
BOARD_KERNEL_CMDLINE := console=ttymxc0,115200 earlycon=ec_imx6q,0x30860000,115200 init=/init firmware_class.path=/vendor/firmware loop.max_part=7 bootconfig
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
      ...
      imx8mq-dcss-lvds:imx8mq-smarc-dcss-lvds.dtb \
      imx8mq-lcdif-lvds:imx8mq-smarc-lcdif-lvds.dtb \
      imx8mq:imx8mq-smarc.dtb \
      imx8mq-hdmi:imx8mq-smarc-hdmi.dtb \
      imx8mq-dp:imx8mq-smarc-dp.dtb \
      imx8mq-dual-display:imx8mq-smarc-dual-display.dtb
endif
