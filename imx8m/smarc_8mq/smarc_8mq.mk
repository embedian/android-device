...
# IMX_DEVICE_PATH refers to the Embedian board folder
# NXP_DEVICE_PATH refers to the NXP EVK folder
NXP_DEVICE_PATH := $(CONFIG_REPO_PATH)/imx8m/evk_8mq
...
-include device/embedian/common/imx_path/ImxPathConfig.mk
include $(CONFIG_REPO_PATH)/imx8m/ProductConfigCommon.mk

# -------@block_common_config-------

# Overrides
PRODUCT_NAME := smarc_8mq
PRODUCT_DEVICE := smarc_8mq
PRODUCT_MODEL := SMARC_8MQ
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/powerhint_imx8mq.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mq.json
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/thermal_info_config_imx8mq.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mq.json
...
# Audio card json
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/audio-json/sgtl5000_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/sgtl5000_config.json \
...
# -------@block_camera-------
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/camera_config_imx8mq.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mq.json \
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/init.imx8mq.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nxp.imx8mq.rc \
