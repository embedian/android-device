...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    $(OUT_DIR)/target/product/$(firstword $(PRODUCT_DEVICE))/obj/UBOOT_COLLECTION/u-boot-imx8mq-trusty-smarc_4g.imx:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
endif
...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_REPO_PATH)/../nxp/common/audio-json/cdnhdmi_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/cdnhdmi_config.json \
...
# GPU openCL g2d
PRODUCT_COPY_FILES += \
    vendor/nxp-opensource/imx/opencl-2d/cl_g2d.cl:$(TARGET_COPY_OUT_VENDOR)/etc/cl_g2d.cl
