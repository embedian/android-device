...
# -------@block_common_config-------
# Overrides
PRODUCT_NAME := smarc_8mp
PRODUCT_DEVICE := smarc_8mp
PRODUCT_MODEL := SMARC_8MP
...
PRODUCT_COPY_FILES += \
    $(NXP_DEVICE_PATH)/camera_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mp.json \
    ...
    $(NXP_DEVICE_PATH)/camera_config_imx8mp-only-ov5640.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mp-only-ov5640.json \
    ...
    $(NXP_DEVICE_PATH)/camera_config_imx8mp-dual-basler.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mp-dual-basler.json \
