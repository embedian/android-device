...
BOARD_PREBUILT_DTBOIMAGE := $(OUT_DIR)/target/product/$(PRODUCT_DEVICE)/dtbo-imx8mp-hdmi.img
...
CMASIZE=1184M
# NXP default config
BOARD_KERNEL_CMDLINE := console=ttymxc1,115200 earlycon=imxuart,0x30890000,115200 init=/init firmware_class.path=/vendor/firmware loop.max_part=7 bootconfig
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
    ...
    imx8mp:imx8mp-smarc.dtb \
    imx8mp-hdmi:imx8mp-smarc-hdmi.dtb \
    imx8mp-lvds:imx8mp-smarc-lvds.dtb
endif
