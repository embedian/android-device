...
set imx8mm_uboot_feature=dual trusty-dual smarc-uuu trusty-secure-unlock-dual
set imx8mp_uboot_feature=dual trusty-dual smarc-uuu pitx-uuu trusty-secure-unlock-dual
...
set imx8mp_dtb_feature=hdmi lvds rs485 lvds-rs485
set imx8mq_dtb_feature=hdmi dp dcss-lvds lcdif-lvds dual-display
